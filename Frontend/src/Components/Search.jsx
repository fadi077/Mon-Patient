        ...
        <div className="content">
            <main className=''>
                <div className="header">
                    ...
                    <div className="w-60 flex items-center p-3">
                        <input type="search" placeholder="Search for doctor" className='py-2 px-6 rounded-xl w-60 border-[#2a3556] border-2 outline-none' />
                        <button className="search-btn relative" type="submit"><i className='bx bx-search bg-[#2a3556] absolute right-[2px] -top-5 px-2 py-2 rounded-xl text-white'></i></button>
                    </div>
                </div>
